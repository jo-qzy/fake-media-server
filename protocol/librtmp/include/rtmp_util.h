...
void rtmp_read_uint16_be(uint8_t *ptr, uint16_t *val);

void rtmp_read_uint24_be(uint8_t *ptr, uint32_t *val);

void rtmp_read_uint32_be(uint8_t *ptr, uint32_t *val);

void rtmp_write_uint32_le(uint8_t *ptr, uint32_t val);

void rtmp_read_uint32_le(uint32_t *ptr, uint32_t *val);
